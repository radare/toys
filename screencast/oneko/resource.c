...
#endif
#define	KOTATSUBITMAP	"%/mycur.xbm"	/* default kotatsu bitmap */
#define	KOTATSUBITMASK	"%/mycur_mask.xbm"	/* default kotatsu bitmask */
#define	POSTBITMAP	"%/mycur.xbm"	/* default post bitmap */
#define	POSTBITMASK	"%/mycur_mask.xbm"	/* default post bitmask */
#define	CURSORBITMAP	"%/mycur.xbm"	/* default cursor bitmap */
#define	CURSORBITMASK	"%/mycur_mask.xbm"	/* default cursor bitmask */
