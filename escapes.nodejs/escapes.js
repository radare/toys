...
const FG = BLACK;
  ...
  function Canvas () {
    var canvas = new CairoCanvas(); // document.createElement('canvas');
...
*/
  ...
  Cursor.prototype = {
    ...
    clearCanvas: function () {
      this.context.fillStyle = 'rgba(' + this.getColor(BG).toString() + ')';
    ...
    trimCanvas: function () {
      var new_height = this.canvas.height, // (this.row + this.scrollback) * 16,
        image_data = this.context.getImageData(0, 0, this.canvas.width, new_height);
